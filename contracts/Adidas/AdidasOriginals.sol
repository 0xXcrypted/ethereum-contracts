...
contract AdidasOriginals is AbstractERC1155Factory, PaymentSplitter  {
    ...
    uint256 constant MAX_SUPPLY = 30000; // 전체 개수 30000개
    uint256 constant MAX_EARLY_ACCESS = 20380; // 초기 접근 개수 20380개
    ...
    constructor(
        ...
        _mint(0x5b1AB6A09297C57911D1971537F569143a601B93, 0, 380, ""); // 특정 지갑에 380개를 민트함. ex팀물량
    }
